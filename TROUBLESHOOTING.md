...
# Or use the MCP tool for comprehensive diagnostics:
...
**Solutions**:
1. **Ensure Socket Connection**: These tools now rely entirely on the WebSocket connection.
2. **Refresh Data**: Try running `refresh_world_data` or restarting the MCP server.
